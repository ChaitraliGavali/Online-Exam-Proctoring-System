...
#
label_l1 = tk.Label(root, text="___Online Proctoring Exam___",font=("Times New Roman", 30, 'bold'),
                    background="brown", fg="white", width=60, height=2)
...
title.place(x=615,y=165,width=240)
        
Login_frame=tk.Frame(root,bg="white")
Login_frame.place(x=450,y=260)
...
# button1 = tk.Button(label_l1, text="HOME", command=home, width=8, height=1,font=('times 15 bold underline'),bd=2, bg="brown", fg="white")
# button1.place(x=146, y=50)

# button2 = tk.Button(root, text="REGISTER",command=reg,width=12, height=1,font=('times 15 bold underline'), bd=2,bg="orange", fg="white")
# button2.place(x=185, y=325)

# button4 = tk.Button(root, text="EXIT", command=window, width=12, height=1,font=('times 15 bold underline'),bd=2,bg="orange", fg="white")
# button4.place(x=185, y=375)
