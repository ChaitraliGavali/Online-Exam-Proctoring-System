...
def show():
    global file
    file = askopenfilename(initialdir=r'D:/All Code/Project Done/Proctoring Exam 100% Code/profile images', title='Select Image',
                                       filetypes=[("all files", "*.*")])
...
def insertBLOB():
    ...
    try:
        ...
        sqlite_insert_blob_query = """ INSERT INTO registration
                                  (RollNo,Fullname, address, Email, Phoneno, Gender, age , photo) 
                                  VALUES (?,?,?,?,?,?,?,?)"""
